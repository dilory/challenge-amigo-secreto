...
function agregarAmigo() {
    ...
    if (nombreAmigo === '') {
        ...
        // alerta para que el usuario evite agregar un elemento vacío a la lista
    } else {
        amigos.push(nombreAmigo);
        // se agrega el nombre al array
        console.log(amigos);
        limpiarCaja();
        // función para limpiar el input después de agregar un nombre
        enlistarAmigo();
        // función para mostrar la lista de nombres que se van agregando
    }
...
function enlistarAmigo() {
    ...
    for (let i = 0; i < amigos.length; i++){
        ...
        // capta el texto en el aaray y lo introduce en la lista
        amigoAgregado.appendChild(lista);
        // toma la nueva lista <li> y la agrega a <u> en el HTML
    }
}
